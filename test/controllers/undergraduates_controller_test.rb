...
class UndergraduatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create undergraduate" do
    assert_difference('Undergraduate.count') do
      post undergraduates_url, params: { undergraduate: { isAble: @undergraduate.isAble, name: @undergraduate.name } }
    end
  ...
  test "should update undergraduate" do
    patch undergraduate_url(@undergraduate), params: { undergraduate: { isAble: @undergraduate.isAble, name: @undergraduate.name } }
